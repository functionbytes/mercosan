                ...
                <div class="d-md-block mt-5 mt-md-0 mb-5">
                    ...
                    <div class="thank-you text-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0">{{ __('Thank you for purchasing our products!') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="pt-3 mb-3 order-item-info">
                                    ...
                                    @foreach ($order->products as $orderProduct)
                                        <div class="row cart-item">
                                            ...
                                            <div class="col-lg-5 col-md-5">
                                                <p class="mb-2 mb-md-0 title-product">{!! BaseHelper::clean($orderProduct->product_name) !!}</p>
                                                <p class="mb-2 mb-md-0 attributes-product">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-4 float-md-end text-md-end">
                                                <p class="price-product">{{ format_price($orderProduct->price) }}</p>
                                            </div>
                                        </div>
                                    @endforeach
                        ...
                        <div class="row">
                            <div class="col-6">
                                <p class="resume-title">{{ __('Total') }}:</p>
                            </div>
                    ...
                    <div class="order-customer-info">
                        ...
                        <p>
                            <span class="d-inline-block-title">{{ __('Order number') }}</span>
                    ...
                    @if ($userInfo->id)
                            @if ($userInfo->name)
                                <p>
                                    <span class="d-inline-block-title">{{ __('Full name') }}:</span>
                            ...
                            @if ($userInfo->phone)
                                <p>
                                    <span class="d-inline-block-title">{{ __('Phone') }}:</span>
                            ...
                            @if ($userInfo->email)
                                <p>
                                    <span class="d-inline-block-title">{{ __('Email') }}:</span>
                            ...
                            @if ($order->full_address && in_array('address', EcommerceHelper::getHiddenFieldsAtCheckout()) && ! empty($isShowShipping))
                                <p>
                                    <span class="d-inline-block-title">{{ __('Address') }}:</span>
                        ...
                        @if (is_plugin_active('payment') && $order->payment->id)
                            ...
                            <p>
                                <span class="d-inline-block-title">{{ __('Payment status') }}:</span>
                                <span
                    ...
                    @if ($tax = $order->taxInformation)
                        <div class="order-customer-info">
                            ...
                            <p>
                                <span class="d-inline-block-title">{{ __('Company name') }}:</span>
                                <span class="order-customer-info-meta">{{ $tax->company_name }}</span>
                            </p>

                            <p>
                                <span class="d-inline-block-title">{{ __('Company tax code') }}:</span>
                                <span class="order-customer-info-meta">{{ $tax->company_tax_code }}</span>
                            </p>

                            <p>
                                <span class="d-inline-block-title">{{ __('Company email') }}:</span>
                                <span class="order-customer-info-meta">{{ $tax->company_email }}</span>
                            </p>

                            <p>
                                <span class="d-inline-block-title">{{ __('Company address') }}:</span>
