...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    */
          ...
          if (res.data.next_url !== undefined) {
            ...
            $.ajax({
              ...
              error: function error(xhr, status, _error) {
                console.error('Cart AJAX request failed:', xhr.responseText, status, _error);
    ...
    function findProductInCart(cartContent, productId) {
      if (!cartContent || _typeof(cartContent) !== 'object') {
        return null;
      }

      // Iterar sobre todas las entradas del carrito
      for (var _i = 0, _Object$entries = Object.entries(cartContent); _i < _Object$entries.length; _i++) {
        ...
        if (item && item.id && item.id.toString() === productId.toString()) {
          ...
          return {
            ...
            image: ((_item$options = item.options) === null || _item$options === void 0 ? void 0 : _item$options.image) || '',
            sku: ((_item$options2 = item.options) === null || _item$options2 === void 0 ? void 0 : _item$options2.sku) || '',
            // Datos calculados
    ...
    function getProductInfoFromButton(button) {
      var productCard = button.closest('.product-card, .product-item, .product, [data-product]');
      return {
        id: button.data('id'),
    ...
    $(document).ready(function () {
      ...
      var $productListing = $(document).find('.products-listing');
  ...
  $(document).ready(function () {
    ...
    function checkCaptchaStatus() {
      ...
      var captchaResponse = $('.bb-newsletter-inline-form .g-recaptcha-response').val() || $('.bb-newsletter-inline-form [name="g-recaptcha-response"]').val() || $('[name="g-recaptcha-response"]').val();
    ...
    if ($.fn.validate) {
      ...
      var clearDuplicateMessages = function clearDuplicateMessages() {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor/core/plugins/social-login/css/social-login","vendor/core/plugins/translation/css/translation","themes/wowy/css/rtl","themes/wowy/css/style","vendor/core/core/base/css/libraries/select2.rtl","vendor/core/core/base/css/core.rtl","vendor/core/core/base/css/crop-image","vendor/core/core/base/css/tree-category","vendor/core/core/base/css/error-pages","vendor/core/core/base/css/libraries/select2","vendor/core/core/base/css/core","vendor/core/core/media/css/media","vendor/core/core/setting/css/admin-email","vendor/core/core/table/css/table","vendor/core/packages/get-started/css/get-started","vendor/core/packages/installer/css/style","vendor/core/packages/menu/css/menu","vendor/core/packages/revision/css/revision","vendor/core/packages/seo-helper/css/seo-helper","vendor/core/packages/shortcode/css/shortcode","vendor/core/packages/slug/css/slug","vendor/core/packages/theme/css/guideline","vendor/core/packages/theme/css/admin-bar","vendor/core/packages/theme/css/theme-options","vendor/core/packages/widget/css/widget","vendor/core/plugins/backup/css/backup","vendor/core/plugins/contact/css/contact-public","vendor/core/plugins/contact/css/contact","vendor/core/plugins/cookie-consent/css/cookie-consent","vendor/core/plugins/ecommerce/css/front-theme-rtl","vendor/core/plugins/ecommerce/css/front-theme","vendor/core/plugins/ecommerce/css/front-review","vendor/core/plugins/ecommerce/css/front-faq","vendor/core/plugins/ecommerce/css/front-ecommerce-rtl","vendor/core/plugins/ecommerce/css/front-ecommerce-missing-bootstrap","vendor/core/plugins/ecommerce/css/front-ecommerce","vendor/core/plugins/ecommerce/css/front-auth","vendor/core/plugins/ecommerce/css/widget","vendor/core/plugins/ecommerce/css/order-return","vendor/core/plugins/ecommerce/css/report","vendor/core/plugins/ecommerce/css/customer","vendor/core/plugins/ecommerce/css/review","vendor/core/plugins/ecommerce/css/currencies","vendor/core/plugins/ecommerce/css/ecommerce-product-attributes","vendor/core/plugins/ecommerce/css/ecommerce","vendor/core/plugins/faq/css/faq","vendor/core/plugins/language/css/language-public","vendor/core/plugins/language/css/language","vendor/core/plugins/newsletter/css/newsletter","vendor/core/plugins/payment/css/payment-setting","vendor/core/plugins/payment/css/payment","vendor/core/plugins/simple-slider/css/simple-slider"], () => (__webpack_require__("./public/vendor/core/core/base/css/libraries/select2.css")))
