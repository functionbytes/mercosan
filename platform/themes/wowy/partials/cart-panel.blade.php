                ...
                @if (!empty($product))
                    <li>
                        ...
                        <div class="shopping-cart-title">
                            ...
                            <h3><span class="d-inline-block  qty">{{ $cartItem->qty }}</span> <span class="d-inline-block x"> x </span> <span class="d-inline-block price">{{ format_price($cartItem->price) }}</span> @if ($product->front_sale_price != $product->price)
                        ...
                        <div class="shopping-cart-delete">
                            <a href="#" data-url="{{ route('public.cart.remove', $cartItem->rowId) }}" class="remove-cart-item"><i class="fa fa-times"></i></a>
                        </div>
                    </li>
                @endif
            @endforeach
