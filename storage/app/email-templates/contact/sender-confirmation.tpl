        ...
        <tbody>
            <tr>
                <td class="bb-content bb-pb-0" align="center">
                    ...
                    <h1 class="bb-text-center bb-m-0 bb-mt-md">Gracias por contactar con nosotros!</h1>
                </td>
            </tr>
            <tr>
                <td>
                        ...
                        <tbody>
                            <tr>
                                <td class="bb-content">
                                    ...
                                    <p>¡Gracias por contactarnos! Hemos recibido su mensaje y nuestro equipo lo revisará en breve. Uno de nuestros representantes se pondrá en contacto con usted lo antes posible.</p>

                                    <h4>Aquí están los detalles de su envío:</h4>
                            ...
                            <tr>
                                <td class="bb-content bb-text-center bb-pt-0 bb-pb-xl" align="center">
                                    <p>Si tiene alguna información o pregunta adicional, no dude en responder a este correo electrónico.</p>

                                    <p>¡Agradecemos su interés y nos comunicaremos con usted pronto!</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
