        ...
        <tbody>
            ...
            <tr>
                <td class="bb-content bb-text-muted bb-pt-0 bb-text-center">
                    Si tiene problemas para hacer clic en el botón "Restablecer contraseña", copie y pegue la siguiente URL en su navegador web: <a href="{{ reset_link }}">{{ reset_link }}</a> y péguelo en su navegador. Si no solicitó un restablecimiento de contraseña, ignore este mensaje o contáctenos si tiene alguna pregunta.
                </td>
            </tr>
        </tbody>
    </table>
