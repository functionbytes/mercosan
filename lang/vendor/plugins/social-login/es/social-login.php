...
return [
    'settings' => [
        ...
        'facebook' => [
            ...
            'data_deletion_request_callback_url' => 'Establezca esta URL :url como la URL de solicitud de eliminación de datos en la configuración de la aplicación de Facebook para permitir que los usuarios soliciten la eliminación de sus datos.',
        ],
        'google' => [
        ...
        'linkedin-openid' => [
            ...
            'app_id' => 'ID de aplicación',
            'app_secret' => 'App secreta',
            'helper' => 'Vaya a https://www.linkedin.com/developers/apps/new para crear una nueva aplicación, actualizar el ID de la aplicación y el secreto de la aplicación. La URL de devolución de llamada es: callback.',
        ],
        'style' => 'Estilo',
        'minimal' => 'Mínimo',
        'default' => 'Por defecto',
