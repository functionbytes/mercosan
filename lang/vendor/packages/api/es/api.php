...
return [
    ...
    'api_enabled_description' => 'Habilite o deshabilite la API REST para su sitio web. Al deshabilitarla, no se podrá acceder a ningún punto final de la API.',
    'api_key' => 'API Key',
    'api_key_description' => 'Clave de seguridad opcional para el acceso a la API. Al configurarse, todas las solicitudes de API deben incluir esta clave en el encabezado X-API-KEY.',
    ...
    'push_notifications_enabled_description' => 'Activa o desactiva las notificaciones push para aplicaciones móviles. Si están desactivadas, no se enviarán notificaciones a los dispositivos.',
    ...
    'fcm_service_account_upload_description' => 'Sube el archivo JSON de tu cuenta de servicio de Firebase. El archivo se almacenará de forma segura en el directorio storage/app/firebase/.',
    ...
    'fcm_step_3_title' => '3. Habilitar la API de FCM',
    'fcm_step_3_1' => 'Go to Google Cloud Console',
    'fcm_step_3_2' => 'Habiltar Firebase Cloud Messaging API',
