...
return [
    ...
    'general' => [
        ...
        'cache_time_site_map' => 'Mapa del sitio de cache time',
    ...
    'media' => [
        ...
        'max_upload_filesize_helper' => 'Su servidor permite cargar archivos de tamaño maximo  :size, puede cambiar este valor para limitar el tamaño de los archivos a cargar.',
        ...
        'convert_file_name_to_uuid' => 'Convertir el nombre del archivo a UUID',
        'convert_image_to_webp_helper' => 'WebP es un formato de imagen moderno que ofrece una compresión superior con y sin pérdida para imágenes en la web. Es compatible con Chrome, Firefox, Edge y Opera. La imagen se convertirá a formato WebP al subirla. Solo se aplica a imágenes JPG, JPEG y PNG.',
        'reduce_large_image_size_helper' => 'Al habilitar esta opción, el sistema reducirá el tamaño de las imágenes grandes al cargarlas, tanto en formato JPG como JPEG, PNG y WebP. El ancho y alto máximos de la imagen se ajustarán a los valores que configure a continuación.',
        'customize_upload_path_helper' => 'Personaliza la ruta de carga de los archivos multimedia. Por defecto, el sistema cargará los archivos en la carpeta ":path".',
        'enable_thumbnail_sizes_helper' => 'Habilite esta opción para generar miniaturas de imágenes. Si está deshabilitada, el sistema no generará miniaturas y siempre usará la imagen a tamaño completo.',
        'upload_path_helper' => 'Esa carpeta se creará en /public. La carpeta predeterminada es ":folder". Luego, se subirá a "/public/:folder".',
        'upload_path_warning' => 'El sistema no moverá los archivos existentes a la nueva carpeta. Si desea moverlos, deberá hacerlo manualmente.',
        'upload_path' => 'Ruta de subida',
        'reduce_large_image_size' => 'Reducir el tamaño de las imágenes grandes al cargar',
        'image_max_height_helper' => 'Establezca la altura máxima de la imagen en píxeles. Si este campo está vacío, se conservará la altura original.',
        'image_max_width_helper' => 'Establezca el ancho máximo de la imagen en píxeles. Si este campo está vacío, se conservará el ancho original.',
        'convert_file_name_to_uuid_helper' => 'Al habilitar esta opción, el sistema convertirá el nombre del archivo a UUID al cargarlo. Esto es útil para evitar nombres de archivo duplicados y mejorar la seguridad.',
        'image_max_width' => 'Ancho máximo de la imagen (px)',
        'image_max_height' => 'Altura máxima de la imagen (px)',
        'customize_upload_path' => 'Personalizar la ruta de carga',
        'enable_thumbnail_sizes' => 'Habilitar tamaños de miniatura',
        'watermark_source_helper' => 'Solo se admiten los formatos PNG, JPG y JPEG. Debe usar imágenes de menos de 200 x 200 px y con un tamaño inferior a 50 KB.',
    ],
    'license' => [
    ...
    'cronjob' => [
        ...
        'setup' => [
            ...
            'learn_more' => 'Puede obtener más información sobre el trabajo cron en Laravel.',
    ...
    'cache' => [
        ...
        'form' => [
            ...
            'enable_cache_site_map_helper' => 'Mapa del sitio :url la URL debe almacenarse en caché debido al gran número de páginas. Si tiene pocas páginas, puede desactivar esta opción.',
        ],
    ],
    'appearance' => [
        'title' => 'Apariencia',
